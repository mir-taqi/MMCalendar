...
@interface MMCalendarStickyHeader ()

@property (weak  , nonatomic) UIView  *contentView;
@property (weak  , nonatomic) UIView  *bottomBorder;
@property (weak  , nonatomic) MMCalendarWeekdayView *weekdayView;

@end

@implementation MMCalendarStickyHeader
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        MMCalendarWeekdayView *weekdayView = [[MMCalendarWeekdayView alloc] init];
...
- (void)setMonth:(NSDate *)month
{
    ...
    BOOL usesUpperCase = (self.calendar.appearance.caseOptions & 15) == MMCalendarCaseOptionsHeaderUsesUpperCase;
