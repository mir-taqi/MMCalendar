...
@implementation UIView (MMCalendarExtensions)
...
@implementation CALayer (MMCalendarExtensions)
...
@interface NSCalendar (MMCalendarExtensionsPrivate)

@property (readonly, nonatomic) NSDateComponents *fs_privateComponents;

@end

@implementation NSCalendar (MMCalendarExtensions)
...
@implementation NSMapTable (MMCalendarExtensions)
...
@implementation NSCache (MMCalendarExtensions)
...
@implementation NSObject (MMCalendarExtensions)
