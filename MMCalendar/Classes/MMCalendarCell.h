...
@class MMCalendar, MMCalendarAppearance, MMCalendarEventIndicator;
 ...
 */
@property (weak, nonatomic) MMCalendarEventIndicator *eventIndicator;
...
@property (assign, nonatomic) MMCalendarMonthPosition monthPosition;
...
@interface MMCalendarEventIndicator : UIView
...
@interface MMCalendarBlankCell : UICollectionViewCell
